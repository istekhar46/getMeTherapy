...
const ServiceCard = ({item, index}) => {
  ...
  return (
    <div className='py-[30px] px-3 lg:px-5'>
        ...
        <Link to='/doctors'
        className='w-[44px] h-[44px] rounded-full border border-solid border-[#1811A1E] flex items-center justify-center group hover:bg-primaryColor hover:border-none' 
        >
